            ...
            modelBuilder.Entity("Mailo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordResetToken = "b08b6d77-ed82-46d7-84d3-9fb367bb6d87",
                            PhoneNumber = "01011895030",
                            RegistrationDate = new DateTime(2024, 10, 29, 20, 50, 49, 70, DateTimeKind.Local).AddTicks(542),
                            UserType = 1,
            ...
            modelBuilder.Entity("Mailo.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordResetToken = "1fd2fb47-0f1e-40f2-94dd-b0e6326d2a4a",
                            PhoneNumber = "01011890000",
                            RegistrationDate = new DateTime(2024, 10, 29, 20, 50, 49, 70, DateTimeKind.Local).AddTicks(991),
                            UserType = 2,
                            Username = "AhmedAssemAdmin123",
                            HiringDate = new DateTime(2024, 10, 29, 20, 50, 49, 70, DateTimeKind.Local).AddTicks(986)
                        });
                });
